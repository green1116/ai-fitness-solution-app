...
export const TKG_MIN_COMPETITOR_BRAND_COUNT = 8 as const;
export const TKG_MIN_COMPETITOR_SUPPLIER_COUNT = 8 as const;
export const TKG_MIN_ALTERNATIVE_SOLUTION_COUNT = 8 as const;

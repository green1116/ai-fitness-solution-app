import type { BrandCatalogRuntimeResult, BrandCatalogStageResult } from "./types";
import { BRAND_CATALOG_INTELLIGENCE_VERSION } from "./types";
...
export function finalizeRuntime<TPayload>(input: {
  ...
  payload: TPayload;
  summary: string;
}): BrandCatalogRuntimeResult<TPayload> {
...
export function assertRuntimeSuccess<TPayload>(result: BrandCatalogRuntimeResult<TPayload>): void {

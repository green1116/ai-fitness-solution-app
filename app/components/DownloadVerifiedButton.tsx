...
export default function DownloadVerifiedButton({
  ...
  async function verifyAndDownload() {
    ...
    try {
      ...
      if (!downloadToken) throw new Error("后端未返�?downloadToken");

      // �?成功：使�?downloadToken 下载 PDF
      const pdfUrl =
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
          <div className="w-[520px] rounded-2xl bg-white text-gray-900 shadow-2xl p-6">
            ...
            <div style={{ marginBottom: 12 }}>
              <label className="block mb-2 text-sm font-medium">验证�?/label>

/**
 * V80 Pilot P1/P5 — AI requirement extraction (structured JSON via tender-parser, no duplicate engine)
 */
...
import { enrichRequirementsEvidence } from "./confidence.service";
import type {
  RequirementItem,
  TenderRequirements,
  PageRef,
 ...
 * P5 — attaches evidence spans + confidence per item.
 */
export function extractRequirementsFromParsedTender(input: {
  ...
  return enrichRequirementsEvidence(base, parseResult.pages);
}

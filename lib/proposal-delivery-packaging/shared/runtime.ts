import type { PackagingRuntimeResult, PackagingStageResult } from "./types";
import { PROPOSAL_DELIVERY_PACKAGING_VERSION } from "./types";
...
export function finalizeRuntime<TPayload>(input: {
  ...
  payload: TPayload;
  summary: string;
}): PackagingRuntimeResult<TPayload> {
...
export function assertRuntimeSuccess<TPayload>(result: PackagingRuntimeResult<TPayload>): void {

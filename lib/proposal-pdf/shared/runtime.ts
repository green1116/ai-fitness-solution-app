import type {
  ProposalPdfRuntimeResult,
  ProposalPdfStageResult,
} from "./types";
import { PROPOSAL_PDF_VERSION } from "./types";
...
export function finalizeRuntime<TPayload>(input: {
  ...
  payload: TPayload;
  summary: string;
}): ProposalPdfRuntimeResult<TPayload> {
...
export function assertRuntimeSuccess<TPayload>(
  result: ProposalPdfRuntimeResult<TPayload>,
): void {

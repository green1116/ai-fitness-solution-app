import type { DifferentiationRuntimeResult, DifferentiationStageResult } from "./types";
import { PROPOSAL_DIFFERENTIATION_VERSION } from "./types";
...
export function finalizeRuntime<TPayload>(input: {
  ...
  payload: TPayload;
  summary: string;
}): DifferentiationRuntimeResult<TPayload> {
...
export function assertRuntimeSuccess<TPayload>(result: DifferentiationRuntimeResult<TPayload>): void {

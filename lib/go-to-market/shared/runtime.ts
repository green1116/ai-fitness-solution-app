import type { GtmRuntimeResult, GtmStageResult } from "./types";
import { GO_TO_MARKET_VERSION } from "./types";
...
export function assertRuntimeSuccess<TPayload>(result: GtmRuntimeResult<TPayload>): void {

import type { ResponsePackRuntimeResult, ResponsePackStageResult } from "./types";
import { TENDER_RESPONSE_PACK_VERSION } from "./types";
...
export function finalizeRuntime<TPayload>(input: {
  ...
  payload: TPayload;
  summary: string;
}): ResponsePackRuntimeResult<TPayload> {
...
export function assertRuntimeSuccess<TPayload>(result: ResponsePackRuntimeResult<TPayload>): void {

/**
 * PI-6.1 — Existing product layers reused by delivery readiness.
 * Path/ID refs only — no FE/BE/Data/Integration module imports.
 */
export const DELIVERY_LAYER_IDS = [
  "FRONTEND",
  "BACKEND",
  "DATA",
  "INTEGRATION",
...
export type DeliveryLayerId = (typeof DELIVERY_LAYER_IDS)[number];

export type DeliveryLayerRef = Readonly<{
...
/**
 * Closed catalogue of existing layers consumed by PI-6.
 */
export const DELIVERY_LAYER_CATALOGUE = [
  {
    layerId: "FRONTEND",
...
] as const satisfies readonly DeliveryLayerRef[];

/** Existing Domain module paths (M11–M15 only). */
export const DELIVERY_DOMAIN_IDS = [
  "M11",
  "M12",
  "M13",
  "M14",
...
export type DeliveryDomainId = (typeof DELIVERY_DOMAIN_IDS)[number];

export const DELIVERY_DOMAIN_MODULE_PATHS = {
  M11: "lib/product/m11",
  M12: "lib/product/m12",
  M13: "lib/product/m13",
  M14: "lib/product/m14",
  M15: "lib/product/m15",
} as const satisfies Record<DeliveryDomainId, string>;

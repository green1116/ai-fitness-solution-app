import type {
  AiReadinessRuntimeResult,
  AiReadinessStageResult,
} from "./types";
import { AI_READINESS_VERSION } from "./types";
...
export function finalizeRuntime<TPayload>(input: {
  ...
  payload: TPayload;
  summary: string;
}): AiReadinessRuntimeResult<TPayload> {
...
export function assertRuntimeSuccess<TPayload>(
  result: AiReadinessRuntimeResult<TPayload>,
): void {

/**
 * V75 P8 — Agent sign-off & freeze types (read-only)
 */
import type { AgentComplianceCatalogReport } from "../agent.compliance";

export const V75_AGENT_SIGNOFF_VERSION = "v75-agent-signoff-1" as const;
export const V75_AGENT_FREEZE_VERSION = "v75-agent-freeze-1" as const;
...
export type AgentSignoffSignals = {
  agentReady?: boolean;
  freezeChecklistPass?: boolean;
  agentGatesPass?: boolean;
...
export type LockVersion = {
  ...
  agentSimulation: string;
  agentCompliance: string;
  signoff: typeof V75_AGENT_SIGNOFF_VERSION;
  freeze: typeof V75_AGENT_FREEZE_VERSION;
  upstreamV74DecisionSignoff: string;
  upstreamV74DecisionFreeze: string;
};
...
export type FreezeChecklist = {
  version: typeof V75_AGENT_FREEZE_VERSION;
  itemCount: number;
  passCount: number;
  failCount: number;
...
export type GateSummary = {
  version: typeof V75_AGENT_SIGNOFF_VERSION;
  gateCount: number;
  passCount: number;
  failCount: number;
...
export type AgentFreezeManifest = {
  version: typeof V75_AGENT_FREEZE_VERSION;
  freezeId: string;
  frozenAt: string;
  deploymentId: string;
  ...
  versionLockOk: boolean;
  agentCompliance: AgentComplianceCatalogReport;
...
export type AgentSignoffReport = {
  version: typeof V75_AGENT_SIGNOFF_VERSION;
  signoffId: string;
  signedOffAt: string;
  deploymentId: string;

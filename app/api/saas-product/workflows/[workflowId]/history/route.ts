...
import { handleListWorkflowHistory } from "@/lib/saas-product-api/handlers/audit-handlers";
...
export async function GET(req: NextRequest, context: RouteContext) {
  ...
  return withApiContext(req, (ctx) => handleListWorkflowHistory(ctx, workflowId), { requireTenant: true });
}

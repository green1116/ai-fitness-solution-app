 ...
 */
export const resolveExactSingleOrganizationForUser = cache(
  async function resolveExactSingleOrganizationForUser(
    userId: string,
...
export const resolveExactSingleOrganizationIdForUser = cache(
  async function resolveExactSingleOrganizationIdForUser(
    userId: string,
  ): Promise<string | null> {
